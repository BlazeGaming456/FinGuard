...
const CATEGORY_PATTERNS = [
  { category: "Salary", regex: /\b(salary|payroll|salary credit|salary deposit|income|credited)\b/i },
  { category: "Groceries", regex: /\b(grocery|supermarket|mart|dmart|big bazaar|spencer|reliance fresh|nature(?:'s)? basket|groceries|fresh market)\b/i },
  { category: "Food", regex: /\b(restaurant|dine|dining|cafe|coffee|eatery|swiggy|zomato|ubereats|uber eats|dominos|pizza|burger|biryani|food delivery)\b/i },
  { category: "Rent", regex: /\b(rent|apartment|lease|landlord)\b/i },
  { category: "Utilities", regex: /\b(electricity|water bill|gas bill|internet|mobile recharge|recharge|utility|broadband|wifi|cable|telephone)\b/i },
  { category: "Transport", regex: /\b(uber|ola|taxi|cab|metro|bus|train|flight|airline|railway|transport)\b/i },
  { category: "Shopping", regex: /\b(amazon|flipkart|myntra|shopping|mall|store|purchase|buy|shop)\b/i },
  { category: "Health", regex: /\b(pharmacy|chemist|hospital|clinic|doctor|medical|health|insurance)\b/i },
  { category: "Entertainment", regex: /\b(netflix|spotify|movie|theatre|cinema|concert|event|gaming)\b/i },
];
