...
const CATEGORY_PATTERNS = [
  { category: "Income", regex: /\b(salary|payroll|freelance|interest|opening balance|salary credit|salary deposit|income|credited|neft.*?salary)\b/i },
  { category: "Food & Dining", regex: /\b(restaurant|dine|dining|dinner|lunch|breakfast|cafe|coffee|eatery|swiggy|zomato|ubereats|uber eats|dominos|pizza|burger|biryani|food delivery|eatsure|mcdonald|kfc|starbucks|ccd|chai point|haldiram|smartq|ojas|hotel|freshill|momo|anna dos|oho shaw|vendima|hardcas|joy land|cater|canteen|baker|bakery|sweet)\b/i },
  ...
  { category: "Transport", regex: /\b(uber|ola|taxi|cab|metro|bus|train|flight|airline|railway|transport|rapido|namma metro|fastag|irctc|makemytrip|redbus|yatra|cleartrip|goibibo|indigo|vistara|air india|ixigo|indian r|ixigo)\b/i },
  { category: "Fuel", regex: /\b(petrol|diesel|fuel|gas station|hpcl|bpcl|iocl)\b/i },
  { category: "Utilities & Bills", regex: /\b(electricity|water bill|gas bill|internet|mobile recharge|mobile bill|recharge|utility|broadband|wifi|cable|telephone|airtel|jio|vi|bescom|kseb|tata power|mahavitaran|adani electricity|pgvcl|d2h|tatasky|sun direct|act fibernet|hathway|excitel)\b/i },
  { category: "Entertainment", regex: /\b(netflix|spotify|movie|theatre|cinema|concert|event|gaming|prime|hotstar|bookmyshow|pvr|inox|cinepolis|sony liv|zee5|disney|apple tv|celebration|ipl|match|party|google p|playstore)\b/i },
  { category: "Shopping", regex: /\b(amazon|flipkart|myntra|shopping|mall|store|purchase|buy|shop|ajio|meesho|nykaa|croma|reliance digital|vijay sales|lifestyle|shoppers stop|max fashion|pantaloons|mr diy)\b/i },
  { category: "Health & Fitness", regex: /\b(pharmacy|chemist|hospital|clinic|doctor|medical|health|insurance|apollo|pharmeasy|1mg|netmeds|practo|max healthcare|fortis|manipal|gym|fitness|workout|wellness)\b/i },
  ...
  { category: "Rent", regex: /\b(rent|apartment|lease|landlord|maintenance|furl)\b/i },
  { category: "Transfers", regex: /\b(transfer|to self|account transfer|fund transfer|p2p|ajin|raju|rojin|joshua|shad|thejus|fayiz|shard|suri|kanchan|jitendra|abdulla|manish|radha|hitesh|ehatesha|ramasha|ragib|abhinav|vijay|mohamm|chhotes|taranat|paytm|bharatpe|gpay|phonepe)\b/i },
];
