...
def build_ollama_prompt(clean_text: str) -> str:
    return (
        ...
        'For the category field, you MUST choose exactly one from the following list: '
        '[Salary, Food & Dining, Groceries, Transport, Utilities & Bills, Shopping, Entertainment, Health & Medical, Investments, Rent, Transfers, Miscellaneous, Uncategorized]. '
        'If it is a P2P transfer to an individual, categorize as Transfers. '
        'If it contains POS or UPI with a known merchant, categorize based on the merchant industry. '
        'If the category is unclear or unknown, strictly use Uncategorized. Do not categorize as Transfers unless it is clearly a fund transfer to a person or bank account. '
