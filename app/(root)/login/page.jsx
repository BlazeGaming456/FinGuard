...
export default function LoginPage () {
  ...
  return (
    <AuthLayout>
      ...
      {justRegistered && (
        <div className="bg-success/10 border border-success/30 rounded-lg px-3.5 py-2.5 text-success text-sm mb-5">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div>
          <div className="flex justify-between items-center mb-1.5">
            ...
            <Link href="/forgot-password" className="text-xs text-accent no-underline hover:text-accent-light">
              Forgot password?
            </Link>
          </div>
          <input
