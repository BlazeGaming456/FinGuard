  ...
  useEffect(() => {
    fetch('/api/auth/session')
      ...
      .then(data => {
        ...
        if (data?.user?.provider) setUserProvider(data.user.provider)
      })
  }, [])
  ...
  return (
    <div className='space-y-6 max-w-2xl'>
      ...
      {userProvider === 'credentials' && (
        <div className='stagger-item glass-card rounded-2xl p-7'>
          ...
          <p className='text-text-secondary text-sm mb-6'>
            Only available for email/password accounts. OAuth accounts (Google)
            manage passwords externally.
          </p>
      ...
      <div className='stagger-item glass-card rounded-2xl p-7 border-danger/20 bg-danger/[0.03]'>
        ...
        <p className='text-text-secondary text-sm mb-6'>
          This permanently deletes your account and all transaction data. This
          cannot be undone.
        </p>
